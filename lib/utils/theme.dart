...
class ThemeProvider {
  ...
  static const titleStyle = TextStyle(fontSize: 16, fontFamily: 'bold', color: ThemeProvider.whiteColor);
  static const titleStyle1 = TextStyle(fontSize: 18, fontFamily: 'bold', color: ThemeProvider.whiteColor, fontWeight: FontWeight.w600);
  static const titleStyle2 = TextStyle(fontSize: 16, fontFamily: 'bold', color: ThemeProvider.blackColor, fontWeight: FontWeight.w600);
